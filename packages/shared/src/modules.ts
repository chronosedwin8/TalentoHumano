...
export const MODULE_CATALOG: ModuleDefinition[] = [
  ...
  {
    key: MODULES.RECRUITING,
    labelKey: 'modules.recruiting',
    icon: 'UserSearch',
    path: '/recruiting',
    order: 30,
  },
  ...
  },
  {
    ...
    labelKey: 'modules.communication',
    icon: 'Megaphone',
    path: '/communication',
    order: 90,
    selfService: true,
  ...
  {
    key: MODULES.HELPDESK,
    labelKey: 'modules.helpdesk',
    icon: 'LifeBuoy',
    path: '/helpdesk',
    order: 130,
    selfService: true,
